<?php
  ...
  $id = $_GET['parcelID'];
    ...
    $strSQL2 = "SELECT * FROM parcel LEFT JOIN department ON department_number = department_id WHERE parcel_id='$id' ";
    $objQuery2 = mysql_query($strSQL2) or die ("Error Query [".$strSQL2."]");
    $objResult2 = mysql_fetch_array($objQuery2);

    $par_name = $objResult2["name"];
    $pnumber = $objResult2["parcel_id"];
    $price_default =  $objResult2["price"];
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    $dep = $shw["depreciate"];//ค่าเสื่อม

                                    $date_old = $objResult2["date_buy"];
                                    $dn = date('Y');
                                    $date=date_create($date_old);
                                    $date_o = date_format($date,"Y");
                                    $year_result = $dn - $date_o;

                                    $result_dep = ($price_default/100) * $dep;
                                    $sum_year = $result_dep * $result;

                                    $nm = 0;
                                    while ($nm<=$year_result) {
                                        $sum_result = $price_default; 
                                        $result_dep = ($price_default/100) * $dep;
                                        $price_default = $price_default - $result_dep;
                                        $nm++;
                                    }
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <table id="ta-all">
                                            ...
                                            <tr id="tr-ta">
                                                <td id="td-ta">ราคา+ค่าเสื่อม</td>
                                                <td id="td-ta"><?php echo number_format($sum_result,2); ?> บาท</td>
                                            </tr>
                                            <tr id="tr-ta">
                                            ...
                                            <tr id="tr-ta">
                                                ...
                                                <td id="td-ta"><?php echo $objResult2["department_name"]; ?></td>
                                            </tr>
                                            <tr id="tr-ta">
                                            ...
                                            <tr id="tr-ta">
                                                ...
                                                <td id="td-ta"><?php echo date("d-m-Y",strtotime($objResult2["date_buy"]));?></td>
                                            </tr>
                                            <tr id="tr-ta">
                                                <td id="td-ta">วันที่ตรวจสอบ</td>
                                                <td id="td-ta"><?php echo date("d-m-Y",strtotime($objResult2["date_check"]));?></td>
                                            </tr>
                                        </table><br>
                                        ...
                                        <a href="parcel_department.php?parcelID=<?php echo $objResult2["department_number"]; ?>" class="btn btn-lg btn-info btn-block" style="width: 40%; margin-left: 60%; cursor: pointer;" id="hver">ย้อนกลับ</a>
                                    </div>
                                </div>
                            </div>
                        </div>
