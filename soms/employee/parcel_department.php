                                        ...
                                        <tbody>
                                            <tr>
                                                <?php  
                                                    if ($result > '5') {
                                                ?>
                                                <td id="red-clor"><div align="center"><?php echo $show['name']; ?></div></td>
                                                ...
                                                <td id="red-clor"><div align="center"><a href="show_detail.php?parcelID=<?php echo $show["parcel_id"]; ?>" class="fas fa-edit"></a> &nbsp;<a href="function/parcel-delete.php?idp=<?php echo $show["parcel_id"]; ?>&departid=<?php echo $idp; ?>" class="fas fa-trash-alt" style="color: red;"></a></div></td>
                                                <?php }else{ ?>
