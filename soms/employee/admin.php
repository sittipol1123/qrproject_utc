                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="parcel_add.php">
                                <i class="fas fa-plus-square"></i>เพิ่มข้อมูลพัสดุ</a>
                        </li>
                        <li>
                            <a href="parcel_show.php">
                                <i class="fas fa-book"></i>พัสดุทั้งหมด</a>
                        </li>
                        <li>
                            <a href="parcel_edit.php?page=1">
                                <i class="fas fa-cogs"></i>จัดการพัสดุ</a>
                        </li>
                    </ul>
                </nav>
            </div>
                               ...
                               <!-- <div class="noti-wrap">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?php echo $objResult['firstname'];?> <?php echo $objResult['lastname']; ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                        <i class="zmdi zmdi-account"></i>Setting</a>
                                                </div>
                                                <div class="account-dropdown__item">
                ...
                <div class="section__content section__content--p30">
                                ...
                                <div class="table-responsive table--no-card m-b-40" style="width: 135%;">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php 
                                            session_start();
                                            include('connect/connection.php');
                                            $sql = "SELECT * FROM upload ORDER BY list_number DESC LIMIT $start , $perpage ";
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?php echo $show['date_up']; ?></td>
                                                <td><?php echo $show['user_up']; ?></td>
                                                <td><?php echo $show['parcel_up']; ?></td>
                                            </tr>
                                        </tbody>
                                        <?php } ?>
                                    </table>     
                    ...
                    <div>
                        <?php
                            ...
                            ?>
                            <a href="admin.php?page=<?php echo $page-1; ?>">&laquo;</a>
                            <?php } ?>
                            <!--
                            <?php
                            ...
                            <?php 
                                if ($page == $total_page) {
                            ?>
                            <a href="admin.php?page=<?php echo $total_page; ?>">&raquo;</a>
                            <?php }else{ ?>
                            <a href="admin.php?page=<?php echo $page+1; ?>">&raquo;</a>
                            <?php } ?>
                            </div>
                </div>
                </div>
