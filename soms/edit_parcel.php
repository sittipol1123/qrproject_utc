                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                       <!-- <p>หมายเลขครุภัณฑ์ : <?php echo $objResult2["parcel_number"];?></p>
                                        ...
                                        <form method="post" action="function/edit_parcel_all.php?idp=<?php echo $objResult2["parcel_id"]; ?>&fkp=<?php echo $img["id_parcel"]; ?>">

                                            <label>หมายเลขครุภัณฑ์</label><br>
                                            <input class="form-control" type="number" name="parcel_num" value="<?php echo $objResult2["parcel_number"]; ?>"><br>
