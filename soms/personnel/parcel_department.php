                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix" style="background-color: #a18de0;">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#" style="color: white;"><?php echo $objResult1['firstname'];?> <?php echo $objResult1['lastname']; ?></a>
                                                    </h5>
                                                    <span class="email" style="color: white;">Status : <?php echo $objResult1['status']; ?></span>
                                                </div>
                                            </div>
    ...
    <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="card-header" id="clor" style="width: 135%; height: 60px;">
                                    <form method="post" action="parcel_department.php?parcelID=<?php echo $idp; ?>">
                                        <input type="test" name="searching" class="form-control" style="width: 50%; position: absolute;" value="<?php echo $_POST["searching"]; ?>" placeholder="ค้นหา">
                                        <div style="float: left; margin-left: 400px; margin-top: 5px;">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th id="headend"><div align="center">รายละเอียด</div></th>
                                            </tr>
                                        </thead>
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM parcel WHERE department_number = '$idp' LIMIT $start , $perpage";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><div align="center"><a href="show_detail.php?parcelID=<?php echo $show["parcel_id"]; ?>&idp=<?php echo $idp; ?>">ดูรายละเอียด</a></div></td>
                                            </tr>
                                        </tbody>
                                        <?php } ?>
                                    </table>     
                    ...
                    <div>
                        <?php
                            ...
                            <?php
                                if ($page == "1") {
                            ?>
                            <a href="parcel_department.php?page=1">&laquo;</a>

                            <?php
                            }else{
                            ?>
                            <a href="parcel_department.php?page=<?php echo $page-1; ?>">&laquo;</a>
                            <?php } ?>
                            ...
                            <?php 
                                if ($page == $total_page) {
                            ?>
                            <a href="parcel_department.php?page=<?php echo $total_page; ?>">&raquo;</a>
                            <?php }else{ ?>
                            <a href="parcel_department.php?page=<?php echo $page+1; ?>">&raquo;</a>
                            <?php } ?>
                        <?php }else{ 
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><div align="center"><a href="show_detail.php?parcelID=<?php echo $show["parcel_id"]; ?>&idp=<?php echo $idp; ?>"></a>ดูรายละเอียด</div></td>
                                </tr>
                            </tbody>
                        <?php } } ?>
                            </div>
