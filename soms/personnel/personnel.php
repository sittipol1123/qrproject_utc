                            ...
                            <div class="col-lg-9">
                                <div class="table-responsive table--no-card m-b-40" style="width: 135%;">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div align="center"><?php echo $show['date_up']; ?></div></td>
                    ...
                    <div>
                        <?php
                            ...
                            <?php
                                if ($page == "1") {
                            ?>
                            <a href="personnel.php?page=1">&laquo;</a>

                            <?php
                            }else{
                            ?>
                            <a href="personnel.php?page=<?php echo $page-1; ?>">&laquo;</a>
                            <?php } ?>
                            <!--
                            <?php
                            ...
                            <?php 
                                if ($page == $total_page) {
                            ?>
                            <a href="personnel.php?page=<?php echo $total_page; ?>">&raquo;</a>
                            <?php }else{ ?>
                            <a href="personnel.php?page=<?php echo $page+1; ?>">&raquo;</a>
                            <?php } ?>
                        </div>
                </div>
                </div>
