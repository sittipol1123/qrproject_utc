<?php
	...
	$sql .= "(parcel_id,name,parcel_number,type_number,department_number,price,date_buy,date_check,detail,budget_of_buy)";
	$sql .= "VALUE";
	$sql .= "('".' '."','".$p_name."','".$parcel_number."','".$type_p."','".$departid."','".$price."','".$date_buy."','".$datenow."','".$deta."','".$budget_buy."')";
	...
	if ($_FILES['image_in']['tmp_name'][0] != null && $_FILES['image_in2']['tmp_name'][0] != null && $_FILES['image_in3']['tmp_name'][0] != null && $_FILES['image_in4']['tmp_name'][0] != null && $_FILES['image_in5']['tmp_name'][0] != null) {
		...
		$sel .= "VALUES";
		$sel .= "('".$parcel_number1."','".$image_name."','".$image_name2."','".$image_name3."','".$image_name4."','".$image_name5."')";
		$chk = mysql_query($sel);
		if ($chk) {
		...
		$sel .= "(id_parcel,img_1,img_2,img_3,img_4,img_5)";
		$sel .= "VALUES";
		$sel .= "('".$parcel_number1."','".$image_name."','".$image_name2."','".$image_name3."','".$image_name4."','".' '."')";
		$chk = mysql_query($sel);
		if ($chk) {
			$selp = "SELECT * FROM parcel WHERE parcel_number = '$parcel_number'";
			$selpquery = mysql_query($selp);
		...
		$sel .= "(id_parcel,img_1,img_2,img_3,img_4,img_5)";
		$sel .= "VALUES";
		$sel .= "('".$parcel_number1."','".$image_name."','".$image_name2."','".$image_name3."','".' '."','".' '."')";
		$chk = mysql_query($sel);
			if ($chk) {
				$selp = "SELECT * FROM parcel WHERE parcel_number = '$parcel_number'";
				$selpquery = mysql_query($selp);
		...
		$sel .= "(id_parcel,img_1,img_2,img_3,img_4,img_5)";
		$sel .= "VALUES";
		$sel .= "('".$parcel_number1."','".$image_name."','".$image_name2."','".' '."','".' '."','".' '."')";
		$chk = mysql_query($sel);
			if ($chk) {
				$selp = "SELECT * FROM parcel WHERE parcel_number = '$parcel_number'";
				$selpquery = mysql_query($selp);
